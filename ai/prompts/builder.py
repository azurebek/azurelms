    ...
    def build(
        ...
        *,
        ...
        return (
            ...
            "- Foydalanuvchining qisqa xabarlari ('davom et', 'yana', 'ha', bitta so'z yoki harf) "
            "deyarli har doim OXIRGI mavzuga tegishli — mavzuni almashtirmang, suhbatni qaytadan boshlamang.\n"
            ...
            "- Mavzuni foydalanuvchi o'zi o'zgartirmaguncha ushlab turing; o'zgartirsa esa yangi mavzuga "
            "to'liq o'ting — eski mavzuni majburan qaytarib olib kelmang.\n\n"
