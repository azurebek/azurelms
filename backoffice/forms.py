...
class BackofficeLandingPageForm(forms.ModelForm):
    class Meta:
        ...
        fields = (
            ...
            "how_it_works_step_four_title",
            "how_it_works_step_four_description",
        ...
        widgets = {
            ...
            "how_it_works_title": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_subtitle": forms.TextInput(attrs={"class": "form-control"}),
            ...
            "how_it_works_step_one_title": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_one_description": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_two_title": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_two_description": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_three_title": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_three_description": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_four_title": forms.TextInput(attrs={"class": "form-control"}),
            "how_it_works_step_four_description": forms.TextInput(attrs={"class": "form-control"}),
