...
7. **Operatsion qiymat kodda qotirib qo'yilmaydi** (owner qarori, 2026-09-11: «qotirib qo'yiladigan qiymatlar qo'yma, masalan 1 soat oldin yuborilsin desam 1 soat qilma uni — men admin paneldan o'zgartira olayin kerak bo'lganda»). Vaqt, oyna, limit, chegara va yoqish/o'chirish ishlab turgan tizimda, deploy'siz o'zgarishi kerak: qiymat DB'dagi sozlamada (naqsh — `aicontrol.AISettings`: singleton, maydonda `default=`, `help_text` bilan izoh), env faqat fallback, maydonda chegara validatori, o'zgarish esa auditlanadi (§A2 qoidasi: sabab + tasdiq + `SystemAuditEvent`). **Ikki istisno ataylab kodda qoladi:** protokol faktlari (Telegram xabarining 4096 belgisi, HMAC algoritmi) va kafolatni ushlab turuvchi qo'riqchilar (masalan issiq siklni oldini oluvchi minimal kechikish) — ularni «sozlash» sozlama emas, nosozlik yo'li. Sinov savoli: *owner buni jonli dars kunida o'zgartirishni xohlashi mumkinmi, va o'zgartirish xavfsizmi?* Ikkisiga ham «ha» bo'lsa — sozlama.
