...
parol page lifecycle’da tozalanadi. PR131 `af4ed76` main’da;
[qamrov va dalil](frontend-v1/I5B-ACCOUNT-PROFILE.md); AWS yoqilmagan.
...
2026-09-25 AWS `363ff95`da public/learning/lesson/teacher/human messenger
V1 override ON. Owner tasdiqlagan synthetic HTTPS/WSS oqim, 320/1280
browser va renderer rollback tekshirildi; sinov hisoblari faolsizlantirildi.
Real-device/owner kontenti qabuli ochiq. Hisob/settings, AI va ko‘chirilmagan
yuzalar legacy. [Public dalili](frontend-v1/R1-PUBLIC-RELEASE.md),
[ichki rollout](frontend-v1/R1-INTERNAL-RELEASE.md).
