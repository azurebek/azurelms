...
GEMINI_REQUEST_TIMEOUT_MS = env_positive_int("GEMINI_REQUEST_TIMEOUT_MS", 15000)
GEMINI_DEADLINE_MS = env_positive_int("GEMINI_DEADLINE_MS", 35000)
...
# Tekshiruv mantig'i Django'niki, matni o'zbekcha — sabab
# `users/password_validation.py` boshida yozilgan.
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        "NAME": "users.password_validation.CommonPasswordValidator",
    },
    {
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "classbook": "fas fa-bolt",
        "classbook.Exercise": "fas fa-shapes",
        "classbook.LessonPlaybook": "fas fa-list-check",
        "classbook.ActivityRun": "fas fa-bolt",
        "classbook.StudentResponse": "fas fa-square-poll-vertical",
